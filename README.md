...
This repository is used to showcase the code and simulation results for the paper "Terrain-Aware UAV-Based Agriculture Monitoring
Using Feature-Driven Reinforcement Learning." We will update the whole experiment code after acceptance. Now, we just put the simulation results for algorithms EI-PAN and EI-GNN.
